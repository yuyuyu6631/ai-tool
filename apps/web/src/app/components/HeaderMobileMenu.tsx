...
export default function HeaderMobileMenu({ currentPath, authHref }: HeaderMobileMenuProps) {
  ...
  return (
    <>
      ...
      {open ? (
        <div id="mobile-menu" className="fixed inset-x-0 top-[68px] z-[60] border-t border-[var(--border-default)] bg-[var(--bg-elevated)] shadow-[var(--shadow-glass)] backdrop-blur-xl md:hidden">
