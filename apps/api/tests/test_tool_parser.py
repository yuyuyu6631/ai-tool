...
# Mock dummy public IP to avoid socket.gaierror for fake.url.com
MOCK_ADDR_INFO = [(socket.AF_INET, socket.SOCK_STREAM, 6, '', ('8.8.8.8', 0))]

@patch("app.services.tool_parser_service.socket.getaddrinfo", return_value=MOCK_ADDR_INFO)
