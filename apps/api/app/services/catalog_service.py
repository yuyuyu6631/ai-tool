...
_REVERSE_CATEGORY_SLUGS: dict[str, str] = {
    alias: canonical for canonical, aliases in LEGACY_CATEGORY_SLUGS.items() for alias in aliases
}
# Also map the canonical slugs to themselves for direct lookups
for canonical in LEGACY_CATEGORY_SLUGS.keys():
