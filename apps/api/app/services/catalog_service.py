...
# O(1) reverse mapping dict for performance optimization
_REVERSE_CATEGORY_SLUGS: dict[str, str] = {
    alias: slug for slug, aliases in LEGACY_CATEGORY_SLUGS.items() for alias in aliases
}
...
def _matches_category(tool: ToolSummary, category_slug: str) -> bool:
    ...
    # O(1) reverse mapping lookup for performance optimization
