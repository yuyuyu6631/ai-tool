...
def list_categories(*, db, include_empty: bool = False, published_tools: list[ToolSummary] | None = None) -> list[CategorySummary]:
...
def get_home_catalog(*, db, section_size: int = 8) -> HomeCatalogResponse:
    ...
    categories = list_categories(db=db, include_empty=False, published_tools=all_tools)
